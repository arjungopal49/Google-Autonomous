 ...
 */
export declare type LatLngTuple = [number, number];
/**
 ...
 * ```
 */
export declare const encode: (path: (number[] | LatLng | LatLngTuple)[], precision?: number) => string;
/**
 ...
 * @ignore
 */
export declare const polylineEncodeLine: (array: (number[] | LatLng | LatLngTuple)[], transform: (latLng: number[] | LatLng | LatLngTuple) => [number, number]) => string;
